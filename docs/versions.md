...
VcRedist `3.0.302` includes the following Redistributables (supported and unsupported):

| Version        | Architecture | Name                                                                       |
| -------------- | ------------ | -------------------------------------------------------------------------- |
| 14.30.30704.0  | x64          | Visual C++ Redistributable for Visual Studio 2022                          |
| 14.30.30704.0  | x86          | Visual C++ Redistributable for Visual Studio 2022                          |
