...
VcRedist `4.1.503` includes the following Redistributables (supported and unsupported):

| Version        | Architecture | Name                                                                       |
| -------------- | ------------ | -------------------------------------------------------------------------- |
| 14.44.35112.1  | x86          | Visual C++ Redistributable for Visual Studio 2022                          |
| 14.44.35112.1  | x64          | Visual C++ Redistributable for Visual Studio 2022                          |
